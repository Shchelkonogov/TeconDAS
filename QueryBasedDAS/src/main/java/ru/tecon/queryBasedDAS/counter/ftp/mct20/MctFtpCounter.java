 ...
 * 07.02.2024
 */
public abstract class MctFtpCounter extends FtpCounter {

    private static final Logger logger = LoggerFactory.getLogger(MctFtpCounter.class);
    ...
    public MctFtpCounter(FtpCounterInfo info) {
        this.info = info;
    }
...
//        System.out.println(filesForLoad);
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(",\n", MctFtpCounter.class.getSimpleName() + "." + info.getCounterName() + "[\n", "\n]");
