...
public enum PlainConfig {
    ...
    ELECTRIC("Состояние электрического ввода", true);

    private final String property;
    private String register;
    private boolean alarm;

    PlainConfig(String property) {
        this.property = property;
    }

    PlainConfig(String property, String register) {
        this.property = property;
        this.register = register;
    }

    PlainConfig(String property, boolean alarm) {
        this.property = property;
        this.alarm = alarm;
    }
