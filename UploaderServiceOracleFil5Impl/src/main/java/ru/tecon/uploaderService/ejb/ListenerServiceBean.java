 ...
 * 30.01.2024
 */
@Stateless(name = "oracleFil5ListenerServiceBean", mappedName = "ejb/oracleFil5ListenerServiceBean")
...
public class ListenerServiceBean implements ListenerServiceRemote {
    ...
    private static final String INS_LISTENER_URL = "insert into ADMIN.OPC_BASE values ('fil5.mipcnet.org', ?, ?)";
    ...
    @EJB(beanName = "oracleFil5UploaderSingletonBean")
        ...
        try (Connection connect = ds.getConnection();
            ...
            for (String counter: listener.getCounterNameSet()) {
                ...
                String url = "https://" + InetAddress.getLocalHost().getCanonicalHostName() + ":" + port +
                        "/oracleFil5UploaderService/api/request?id=[id]&objectId=[objectId]";
